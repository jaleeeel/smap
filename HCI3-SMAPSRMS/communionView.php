...
<body>
    <div class="card">
        <h2><i class="fas fa-book-open"></i> Communion Record</h2>
        <div class="record-row">
            <div class="record-label"><i class="fas fa-user"></i>Name:</div>
            <div class="record-value"><?= htmlspecialchars($record['participant_name']) ?></div>
        </div>
        <div class="record-row">
        ...
        <div class="record-row">
            <div class="record-label"><i class="fas fa-school"></i>School Grade:</div>
            <div class="record-value"><?= htmlspecialchars($record['school_grade']) ?></div>
        </div>
        <div class="record-row">
            <div class="record-label"><i class="fas fa-user-friends"></i>Guardian Name:</div>
            <div class="record-value"><?= htmlspecialchars($record['guardian_name']) ?></div>
        </div>
        <div class="record-row">
            <div class="record-label"><i class="fas fa-phone"></i>Contact:</div>
            <div class="record-value"><?= htmlspecialchars($record['contact']) ?></div>
        </div>
        <div class="record-row">
        ...
        <div class="record-row">
            <div class="record-label"><i class="fas fa-calendar-check"></i>Communion Date:</div>
            <div class="record-value"><?= date('m/d/Y', strtotime($record['communion_date'])) ?></div>
        </div>
        <div class="record-row">
        ...
        <a href="communion.php" class="btn-back"><i class="fas fa-arrow-left"></i> Back to Records</a>
    </div>
</body>
</html>
